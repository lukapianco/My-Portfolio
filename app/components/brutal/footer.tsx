        ...
        <footer className="py-1 bg-black">
            ...
            <div className="w-full p-7 flex max-md:flex-col max-md:gap-4 items-center justify-between">
                ...
                <div className="flex gap-4">
                    <a href="https://github.com/lukapianco" target="blank" className=" flex items-center p-2 border-2 border-accent gap-2 text-sm font-bold text-accent hover:text-black hover:bg-accent transition-colors">
                    ...
                    <a href="https://www.linkedin.com/in/luka-pianco/" target="blank" className=" flex items-center p-2 border-2 border-accent gap-2 text-sm font-bold text-accent hover:text-black hover:bg-accent transition-colors">
